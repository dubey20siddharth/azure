...
bot.dialog("/",[
	function(session)
	{
		builder.Prompts.choice(session, "Please choose any of the services. ", "Image Analytics|Face Description|Custom Vision|OCR|Text Analytics", { listStyle: builder.ListStyle.button });
	},
 ...
 if(hasImageAttachment(session)) {
        ...
        var apiUrl ='https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze?visualFeatures=Tags,Description&details=Landmarks&language=en'
            ...
            var requestData = {
                ...
                headers: {
                     'Content-Type':'application/octet-stream',
                     'Ocp-Apim-Subscription-Key':'a370cad24021430185af0f8d0b7b6b8c'
